...
<div class="form-group">
    ...
    @foreach ($aulas as $aula)
        <option value="{{ $aula->id }}"@if($aula->id == $detalle->Aulas_id) {{'selected'}} @endif>{{ $aula->NumAula }}</option>
    @endforeach
    </select>
</div>
...
<div class="form-group">
    ...
    @foreach ($materias as $materia)
        <option value="{{ $materia->id }}"@if($materia->id == $detalle->Materias_id) {{'selected'}} @endif>{{ $materia->nombremateria }}</option>
    @endforeach
    </select>
</div>
